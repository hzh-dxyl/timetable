...
public class http {
    ...
    public static boolean login(String txtUserID, String txtUserPwd) {
    ...
    public static ArrayList<Lesson> getTimeTable(String txtUserID, String txtUserPwd, String xn, String xq) {
